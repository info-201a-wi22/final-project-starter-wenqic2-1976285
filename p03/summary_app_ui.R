...
Summary <- tabPanel(
  h4("Summary"),
  h1("Summary"),
  p("1) By analyzing our first set of graphs, it can be seen that since 1990, there has been a large
  ...
  p("2) Through analyzing our second set of graphs, we can see that as of 2005 there has been a
  ...
  p("*Pending third graph information")
